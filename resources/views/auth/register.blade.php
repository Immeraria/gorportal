                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" checked required name="remember" id="rules" {{ old('remember') ? 'checked' : '' }}>

                                    <label class="form-check-label" for="rules">
                                        Cогласен с <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">политикой безопасности</a>
                                    </label>
                                </div>
                            </div>
                        </div>
